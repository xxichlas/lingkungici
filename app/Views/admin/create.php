...
<body>
    <div class="container">
        <div class="row">
            <div class="col-8">
                <h1 class="my-3"> Tambah Data event baru</h1>
                <form action="/admin/save" method="POST" enctype="multipart/form-data">
                    ...
                    <div class="row mb-3">
                        ...
                        <div class="col-sm-10">
                            <input type="text" class="form-control <?= ($validation->hasError('category')) ?  'is-invalid' : ''; ?>" id="category" name="category" autofocus value="<?= old('category'); ?>">
                            <div id="validationServer03Feedback" class="invalid-feedback">
                    ...
                    <div class="row mb-3">
                        ...
                        <div class="col-sm-10">
                            <input type="text" class="form-control <?= ($validation->hasError('admission')) ?  'is-invalid' : ''; ?>" id="admission" name="admission" autofocus value="<?= old('admission'); ?>">
                            <div id="validationServer03Feedback" class="invalid-feedback">
